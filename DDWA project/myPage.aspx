...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Container-fluid">
            ...
            <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" Width="1335px">
                <ItemTemplate>
                    <table class="auto-style1">
                        <tr>
                            <td class="auto-style35" style="border: medium solid #00CC99">
                                <asp:Image ID="Image1" runat="server" AlternateText=": )" Height="82px" ImageUrl='<%# Eval("logo") %>' Width="114px" />
                            </td>
                            <td class="auto-style34" colspan="2">
                                <h2>
                                    <asp:Label ID="Label1" runat="server" Height="59px" Text='<%# Eval("b_name") %>' Width="908px"></asp:Label>
                                </h2>
                            </td>
                            <td class="auto-style36" style="border-style: solid; border-color: #00CC99">
                                <asp:ImageButton ID="ImageButton1" runat="server" Height="45px" ImageUrl="~/image/home.JPG" OnClick="ImageButton1_Click" Width="53px" />
                            </td>
                        </tr>
                        <tr>
